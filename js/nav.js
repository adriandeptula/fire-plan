...
function gn(id) {
  ...
  const bnMap = { dash: "dash", portfel: "portfel", budzet: "budzet", kalk: "kalk", wykres: "wykres" };
  ...
  // rBud() i rWykres() sa juz wywolywane przez rA()/_rAImmediate() —
  // wywolywanie ich tu dodatkowo powodowalo podwojny render.
  // rMies, cWyp, rLoans NIE sa wywolywane przez rA() — te zostaja.
  if (id === "mies") rMies();
